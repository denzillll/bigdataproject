-- dim_country: one row per country with stable attributes and peak metrics.
-- Serves as the country dimension for every fact table downstream.
...
final as (
    select
        ...
        -- Bucket countries into income tiers based on GDP per capita.
        case
